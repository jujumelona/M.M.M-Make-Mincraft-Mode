...
Path("minecraft_mod_ai/validation_diagnostic_contract.py").write_text(
    '''from __future__ import annotations
...
Path("minecraft_mod_ai/repair_diagnostics_contract.py").write_text(
    '''from __future__ import annotations
...
replace(
    "minecraft_mod_ai/remote_trajectory_store.py",
...
Path("tests/test_worker12_shared_core.py").write_text(
    '''from __future__ import annotations
...
for obsolete in (
    Path("minecraft_mod_ai/orchestrator_jdt_gate_contract.py"),
    Path("tests/test_orchestrator_jdt_gate_contract.py"),
):
