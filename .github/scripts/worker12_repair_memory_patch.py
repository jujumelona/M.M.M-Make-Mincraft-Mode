...
replacement = '''_REPAIR_MEMORY_MAX_ROWS = 256
...
addition = '''def test_repair_memory_rejects_symlinked_leaf_without_touching_target(tmp_path: Path) -> None:
...
print("worker12 repair-memory hardening applied")
