...
BASE_PATCH = ROOT / ".github" / "scripts" / "apply_fresh_java_root_cause_fix.py"
TRANSITION_TEST = ROOT / "tests" / "test_fresh_java_grounding_transition.py"


def rewrite_transition_test() -> None:
    TRANSITION_TEST.write_text(r'''from __future__ import annotations
