...
class FactType(str, Enum):
    ...
    BLOCK_ENTITY_EXISTS = "BLOCK_ENTITY_EXISTS"
    DATA_COMPONENT = "DATA_COMPONENT"
    WORLDGEN_FEATURE = "WORLDGEN_FEATURE"
    DIMENSION = "DIMENSION"
    BIOME = "BIOME"
    STATUS_EFFECT = "STATUS_EFFECT"
    SOUND_EVENT = "SOUND_EVENT"
    PARTICLE_TYPE = "PARTICLE_TYPE"
    ENTITY_LOOT = "ENTITY_LOOT"
    ADVANCEMENT = "ADVANCEMENT"
    EQUIPMENT_ARMOR = "EQUIPMENT_ARMOR"
    CUSTOM_ITEM_BEHAVIOR = "CUSTOM_ITEM_BEHAVIOR"
    CUSTOM_BLOCK_BEHAVIOR = "CUSTOM_BLOCK_BEHAVIOR"
