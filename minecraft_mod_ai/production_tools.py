...
class ProductionToolService:
    ...
    def java_workspace_symbols(
        ...
        return JavaLanguageService().workspace_symbols(
    ...
    def blockbench_list_tools(self) -> dict[str, Any]:
        ...
        try:
            return {
                ...
                "reviewed_allowlist": list(allowed_blockbench_operations()),
    ...
    def generate_geckolib_entity(
        ...
        *,
        ...
        return generate_geckolib_entity_assets(
            project_root=self._existing_dir(project_root),
            mod_id=mod_id,
    ...
    def runtime_prepare_instance(
        ...
        *,
        ...
        self._approved(proposal, approval_hash)
        return self.runtime.prepare_instance(
            instance_name,
            mod_jar=mod_jar,
    ...
    def run_model_smoke(
        ...
        return run_model_smoke(
            ...
            output_dir=target,
            media_path=(self._existing_file(media_path) if media_path else None),
            audio_path=(self._existing_file(audio_path) if audio_path else None),
        )
    ...
    def export_training_dataset(
        ...
        return TrainingTraceStore(self._resolve(store_path)).export_sft(
    ...
    def system_plugin_ids() -> dict[str, Any]:
        return {
            "schema_version": "mmm/system-plugin-list-v1",
            "plugins": list(supported_system_packs()),
        }
