...
class ProjectInventory:
    ...
    def from_dict(cls, value: Mapping[str, Any]) -> ProjectInventory:
        ...
        from .project_inventory_codec import project_inventory_from_mapping

        return project_inventory_from_mapping(value)
...
def _inspect_project_inventory(
    ...
    *,
    ...
    from .project_inventory_components import (
        build_component_catalog as _build_component_catalog,
        config_components as _config_components,
        resource_components as _resource_components,
        source_components as _source_components,
    )
...
def validate_project_inventory_payload(value: Mapping[str, Any]) -> dict[str, Any]:
    ...
    from .project_inventory_codec import validate_project_inventory_payload as validate
