...
class HostRunState:
    ...
    def take_verifier_repair_guidance(self) -> str | None:
        ...
        return (
            ...
            "repair_window is mandatory for model-facing verifier repair. The diagnostics payload "
            "contains exactly one host-selected diagnostic for that window. Emit only replacement "
