...
def _plan_complete_game_impl(
    self: Any, module: Any, prompt: str, media_paths: Any, existing_input_sha256: str,
    minecraft_version: str, loader: str, existing_minecraft_version: str, existing_loader: str,
) -> dict[str, Any]:
    ...
    return {
        "schema_version": "mmm/complete-plan-result-v4", "profile": self.profile,
        "message": module.render_complete_plan(
            requested_prompt=proposal.requested_prompt, game_design=proposal.game_design,
            modules=proposal.modules, acceptance_tests=proposal.acceptance_tests,
        ),
        "proposal_ref": proposal_ref, "approval_hash": proposal.calculate_hash(),
...
def _install_core_tools(module: Any) -> None:
    ...
    def plan_complete_game(
        ...
        return _plan_complete_game_impl(
            self, module, prompt, media_paths, existing_input_sha256,
            minecraft_version, loader, existing_minecraft_version, existing_loader,
        )
