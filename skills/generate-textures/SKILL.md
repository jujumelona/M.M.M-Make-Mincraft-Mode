...
retry_policy:
  max_attempts: 2
  strategy: regenerate only the failing asset once using the same approved brief plus the concrete format, provenance, or
    visual-review failure; preserve both candidate hashes
