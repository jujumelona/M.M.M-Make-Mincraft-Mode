...
from minecraft_mod_ai.repair_mutation_recovery_contract import (
...
def test_existing_repair_schema_removes_create_delete_and_pins_path() -> None:
    path = "src/main/java/example/DebugToken.java"
    tools = constrain_existing_repair_tools(
...
def test_jdt_core_runtime_failure_is_readiness_not_source_repair_input() -> None:
    ...
    assert jdt_workspace_not_ready({"ok": True, "result": receipt})
