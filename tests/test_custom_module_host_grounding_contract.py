...
def _grounding(kind: str='networking') -> dict:
    return build_coder_grounding(module_kind=kind, source_observation_receipt={'schema_version': 'mmm/source-observation-receipt-v1', 'project_sha256': 'sha256:' + '1' * 64, 'query_sha256': 'sha256:' + '2' * 64, 'observation_count': 3, 'observations_sha256': 'sha256:' + '3' * 64}, research_context={'schema_version': 'mmm/module-research-context-v1', 'corpus_sha256': 'sha256:' + '4' * 64, 'ledger_fact_count': 8, 'selected_record_count': 2, 'selected_fact_count': 2, 'selected_facts_sha256': 'sha256:' + '5' * 64, 'omitted_fact_count': 6}, minecraft_version='1.20.1', loader='fabric', mappings='1.20.1+build.1')
